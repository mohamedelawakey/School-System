...
public class AssignmentForm : Form
{
    ...
    public AssignmentForm()
    {
       ...
       // Add buttons to the panel
        ...
        panel.Controls.Add(btnViewGrades, 0, 3);
        panel.Controls.Add(btnViewAssignments, 0, 4); 
    ...
    // Handles the event when the "View Grades" button is clicked.
    private void BtnViewGrades_Click(object sender, EventArgs e)
    {
        // Opens the ViewGradesForm for viewing grades.
        ViewGradesForm viewGradesForm = new ViewGradesForm();
        // Display the ViewGradesForm
        viewGradesForm.Show();
    }
